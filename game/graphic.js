function init() {
    ...
    ennemies = [new Ennemy("ennemy1", 0xffffff, new THREE.Vector2(45, 0), 0, 0), new Ennemy("ennemy2", 0xFFFFFF, new THREE.Vector2(50, 0), 0.45, 1)]
    for (const ennemy of ennemies) {
        scene.add(ennemy.graphic);
    }


    light1 = new Light("sun", 0xffffff, "250,250,250");
    scene.add(light1);
}
